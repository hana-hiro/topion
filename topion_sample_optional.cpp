...
struct Options : public Topion{
	TOPION_ADD_O(std::string, file, "Input file");
	TOPION_ADD_OC(double, rate, RangeSwitch<double>(0.0, 1.0), "Rate of increases (0 to 1)");
	TOPION_ADD_OA(int, i, "integer", "User ID");
	TOPION_ADD_OAC(short, size, "SIZE", RangeSwitch<short>(1, 1024), "Maximum size of data");
	TOPION_ADD_OS(bool, verbose, 'v', "Display detailed processes");
	TOPION_ADD_OSC(char, input, 'I', CharSwitch("xyz"), "Input type ('x', 'y' or 'z')");
	TOPION_ADD_OSA(unsigned int, trials, 'T', "UINT", "Number of trials");
	TOPION_ADD_OSAC(int, volume, 'V', "-100 to 100", RangeSwitch<int>(-100, 100), "Relative volume");
};
